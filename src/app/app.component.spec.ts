...
describe('AppComponent', () => {
  ...
  describe('with default English translations', () => {
    it('should render the directive translation', waitForAsync(() => {
    ...
    it('should render the pipe translation', waitForAsync(() => {
    ...
    it('should render the service translation', waitForAsync(() => {
    ...
    it('should render the thanks translation for plural values', waitForAsync(() => {
    ...
    it('should render the thanks translation for a single value', waitForAsync(() => {
