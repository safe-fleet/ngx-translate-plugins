  ...
  describe('static construction', () => {
    describe('withTranslations()', () => {
      describe('with language and translations', () => {
        beforeEach(() => {
          translateModule = TranslateTestingModule.withTranslations(ENGLISH_LANGUAGE, ENGLISH_TRANSLATIONS);
        });
        ...
        describe('provided TranslateService', () => {
          ...
          it('should initialize the translations for the language', () => {
            expect(translateService.instant(GREETING_KEY)).toEqual(TRANSLATIONS[ENGLISH_LANGUAGE][GREETING_KEY]);
          });
        });
      });
      ...
      describe('with translations structure', () => {
        ...
        describe('provided TranslateService', () => {
          ...
          it('should initialize the translations', () => {
            ...
            expect(translateService.instant(GREETING_KEY)).toEqual(TRANSLATIONS[SPANISH_LANGUAGE][GREETING_KEY]);
          });
        });
      });
    });
  ...
  describe('instance methods', () => {
    ...
    describe('withTranslations()', () => {
          ...
          it('should merge the translations for the language', waitForAsync(() => {
            ...
            translateService
              ...
              .then((translations) => {
                ...
                expect(translations[GREETING_KEY]).toEqual(TRANSLATIONS[ENGLISH_LANGUAGE][GREETING_KEY]);
                expect(translations[FAREWELL_KEY]).toEqual(ADDITIONAL_ENGLISH_TRANSLATIONS[FAREWELL_KEY]);
              });
          }));
        });
      });
      ...
      it('should have no effect if the translations are null', () => {
        translateModule = TranslateTestingModule.withTranslations(TRANSLATIONS).withTranslations(null);
        expect(translateModule).toBeTruthy();
      });
    });
    ...
    describe('withDefaultLanguage()', () => {
      beforeEach(() => {
        translateModule = TranslateTestingModule.withTranslations(TRANSLATIONS).withDefaultLanguage(SPANISH_LANGUAGE);
      });
